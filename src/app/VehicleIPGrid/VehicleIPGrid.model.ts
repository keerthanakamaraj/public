...
this.rowData[i].Vehicle_Currency = row['Vehicle_Currency'];
this.rowData[i].Vehicle_Amount = row['Vehicle_Amount'];
...
Vehicle_Currency : string = undefined;
Vehicle_Amount : string = undefined;
