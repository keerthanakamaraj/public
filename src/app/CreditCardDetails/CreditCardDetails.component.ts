       ...
       // var noOfError: number = await this.revalidate();
        ...
        if (noOfError == 0) {
            if (this.services.rloCommonData.globalApplicationDtls.CamType == 'LE') {
              if (this.RequestedCardLimit.getFieldValue() != undefined && '' != this.RequestedCardLimit.getFieldValue() && '' != this.CurrentCardLimit.getFieldValue() && this.CurrentCardLimit.getFieldValue() != undefined) {
            ...
            if((undefined==this.SubCamType || ''==this.SubCamType) && 'MEMC' == this.services.rloCommonData.globalApplicationDtls.CamType){
